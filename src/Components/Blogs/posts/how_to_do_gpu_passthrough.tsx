...
export const meta = {
  ...
  title: "How to Do GPU Passthrough",
  date: "2025-12-04",
  tags: ["Linux", "OS", "GPU Passthrough", "Virtualization", "Tech"],
  thumbnail: "/linux.png", // Place your image in public folder
  description:
    "Learn how to set up GPU passthrough on your Linux system for enhanced virtualization performance.",
};
