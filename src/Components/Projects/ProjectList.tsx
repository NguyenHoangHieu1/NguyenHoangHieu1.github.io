    ...
    <section className="mx-auto max-w-5xl px-4 sm:px-6 py-16">
      <div className="mb-10">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Things I've built — personal projects, experiments, and tools.
        </p>
                  ...
                  <div className="flex items-center gap-2 ml-auto">
                    {project.githubUrl && (
                      <a
                        ...
                        className="flex items-center gap-1.5 px-3 py-1.5 text-sm rounded-lg border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:border-gray-300 dark:hover:border-gray-600 transition-colors"
                    ...
                    {project.liveUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-1.5 px-3 py-1.5 text-sm rounded-lg bg-teal-600 hover:bg-teal-700 text-white transition-colors"
